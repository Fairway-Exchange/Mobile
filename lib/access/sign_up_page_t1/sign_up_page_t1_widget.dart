...
import 'sign_up_page_t1_model.dart';
export 'sign_up_page_t1_model.dart';

class SignUpPageT1Widget extends StatefulWidget {
  const SignUpPageT1Widget({super.key});

  @override
  State<SignUpPageT1Widget> createState() => _SignUpPageT1WidgetState();
}

class _SignUpPageT1WidgetState extends State<SignUpPageT1Widget> {
  late SignUpPageT1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SignUpPageT1Model());
                        ...
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: TextFormField(
                              ...
                              cursorColor:
                                  FlutterFlowTheme.of(context).secondaryText,
                              validator: _model.confPassTextControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ),
